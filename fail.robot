...
***Comments***
This test will only fail IF odoo code is edited to remove the check for already existing patients. As this code will only check to see if the
...
Did Error Appear
    Element Should Be Visible    class:modal-content